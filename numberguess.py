""" In this project, we will build a game program that rolls a pair of dice and asks the user to guess the sum. 
...
def roll_dice(number_of_sides):
  ...
  if guess > max_val:
    print ("No guessing higher than the max possible value!")
  else:
    print ("Rolling...")
    sleep(2)
...
roll_dice(6) #you can enter any number you want 